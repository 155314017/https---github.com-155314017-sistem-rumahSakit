...
export default function CustomCalender() {
    ...
    const handleTimeChange = (newValue: Dayjs | null) => {
        ...
        if (newValue) {
            ...
            setInputValue(`${startDate} ${startHour.toString().padStart(2, '0')}:00 - ${endHour.toString().padStart(2, '0')}:00`);
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
            ...
            <Box>
                ...
                <DateTimePicker
                    ...
                    value={selectedTime ? dayjs(`${selectedTime.date} ${selectedTime.start.toString().padStart(2, '0')}:00`) : null}
