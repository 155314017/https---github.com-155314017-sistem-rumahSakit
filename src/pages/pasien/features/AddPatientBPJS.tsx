...
//hooks
import useTambahPatientsBPJS from "../hooks/useAddPatientBPJS";


export default function TambahPatientsBPJS() {
    const { 
        breadcrumbItems,
        currentPage,
        setCurrentPage,
                ...
                <Box position="relative" p={3} sx={{ borderRadius: "24px", bgcolor: "#fff", overflow: "hidden", height:'fit-content' }}>
                    ...
                    {currentPage === 1 && (
                        <Box component="form" noValidate autoComplete="off" mt={3} onSubmit={formik.handleSubmit}>
                            ...
                            <Typography sx={{ fontSize: "16px", mt: 6 }}>Nama Patients<span style={{ color: "red" }}>*</span></Typography>
