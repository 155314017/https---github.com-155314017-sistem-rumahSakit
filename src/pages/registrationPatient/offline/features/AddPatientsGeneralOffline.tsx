...
import useAddPatientsGeneralOffline from "../hooks/useAddPatientsGeneralOffline";
...
export default function AddPatientsGeneralOffline() {
    const {
        validationSchema,
        currentPage,
        setCurrentPage,
