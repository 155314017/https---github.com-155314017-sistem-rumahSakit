        ...
        <>
          ...
          >
            <Box sx={{ ml: 8, mt: '5%', width: '85%' }}>
              <Typography sx={{ fontSize: '32px', fontWeight: '600' }}>Selamat Datang</Typography>
              <Typography
                sx={{ color: 'gray', fontSize: '18px', marginBottom: '30px', width: '100%' }}
              >
                Silahkan masukkan nomor NIK (Nomor induk kependudukan) penanggung jawab.
              </Typography>
                ...
                {({
                  ...
                  <Form>
                    <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                      ...
                      <Typography mt={2}>
                        No. Handphone penanggung jawab <span style={{ color: '#d32f2f' }}>*</span>{' '}
                      </Typography>
                      <PhoneInput
                        country={'id'}
                        onChange={phone => setFieldValue('phone', phone)}
                      ...
                      <Typography sx={{ fontSize: '16px', mt: 2 }}>
                        Alamat tempat tinggal penanggung jawab
                  ...
                  {({ errors, touched, handleChange, isValid, dirty }) => (
                    <Form>
                      <Box sx={{ width: '100%', display: 'flex', flexDirection: 'column' }}>
                        ...
                        >
                          <Typography
                            sx={{ fontSize: '16px', lineHeight: '18px', color: '#A8A8BD' }}
                          >
