                ...
                <Box display={'flex'} flexDirection={'row'} justifyContent={'space-between'} maxWidth={'100%'} >
                    ...
                    <Box maxWidth={'50%'} display={'flex'} flexDirection={'column'} gap={2} >
                        ...
                        <Box display={'flex'} flexDirection={'column'} gap={1} >
                            ...
                            <Typography fontSize={'16px'} fontWeight={600} >{jenisKelamin}</Typography>
                        </Box>

                        <Box display={'flex'} flexDirection={'column'} gap={1} >
                            <Typography>Alamat Tempat Tinggal</Typography>
                            <Typography fontSize={'16px'} fontWeight={600} >{alamat}</Typography>
                        </Box>
                    ...
                    <Box maxWidth={'50%'} display={'flex'} flexDirection={'column'} gap={2} >
                        ...
                        <Box display={'flex'} flexDirection={'column'} gap={1} >
                            ...
                            <Typography fontSize={'16px'} fontWeight={600} >{noHandphone}</Typography>
                        </Box>

                        <Box display={'flex'} flexDirection={'column'} gap={1} >
                            <Typography>Dokumen</Typography>
                            <Typography fontSize={'16px'} fontWeight={600} >{dokumen}</Typography>
                        </Box>
