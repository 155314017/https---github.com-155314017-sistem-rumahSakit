...
export interface CreateSubfacilityRequest {
    name: string;
...
export const createSubfacility = async (
    subfacilityData: CreateSubfacilityRequest,
    ...
    try {
        ...
        const response = await axios.post<ApiResponse<null>>(BASE_URL, subfacilityData, {
            headers: {
